  ...
  if (!isAdmin) {
    return (
      ...
      >
        ...
        <button
          onClick={() =>
            pass === "kajal@2004" ? setIsAdmin(true) : alert("Wrong Password!")
          }
    ...
    <div style={{ padding: "20px", maxWidth: "600px", margin: "auto" }}>
      ...
      >
        ...
        <button
          ...
          style={{
            padding: "12px",
            background: editingId ? "green" : "black",
            color: "white",
          }}
        >
  ...
  return (
    <BrowserRouter>
      <div style={{ padding: "20px", fontFamily: "Arial" }}>
        ...
        <Link to="/cart">
          <button>View Cart: {cart.reduce((a, b) => a + b.quantity, 0)}</button>
        </Link>
        <Link to="/admin">
          <button
                  ...
                  {categories.map((cat) => (
                    <button
                      ...
                      style={{
                        ...
                        padding: "10px 20px",
                        backgroundColor:
                          selectedCategory === cat ? "#007bff" : "#6c757d",
                        color: "white",
                        border: "none",
                        borderRadius: "20px",
                        cursor: "pointer",
                  ...
                  <div>
                    {cart.map((item) => (
                      ...
                      >
                        ...
                        <div>
                          <button onClick={() => decreaseQty(getId(item))}>
                            -
                          </button>
                          <span style={{ margin: "0 5px" }}>
                            {item.quantity}
                          </span>
                          <button onClick={() => increaseQty(getId(item))}>
                            +
                          </button>
                          <button
